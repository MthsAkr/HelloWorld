...
//  TechMon
//
//  Created by Akira Mitsuhashi on 2015/04/03.
//  Copyright (c) 2015年 Akira Mitsuhashi. All rights reserved.
//
...
class ViewController: UIViewController {
    ...
    func finishBattle(vanishImageView: UIImageView, winPlayer: Bool) {
        ...
        var alert = UIAlertController(title: "バトル終了!", message: finishedMassage, preferredStyle: UIAlertControllerStyle.Alert)
        alert.addAction(
            UIAlertAction(
